...
public class ChapterStateSavingPredicatesTest extends PlayTest {
    ...
    @Test
    void canSaveAndResumeWithoutLosingIntegerGameStateVariable() {
        final var preSaveNarrativeService = this.narrativeService;
        game.startNewGame();
        ...
        // Trigger 1-0 -> 2
        game.tick();
        final var saveGame = game.saveGame();
        buildGame();
        this.game.loadGame(saveGame);
        ...
        Assertions.assertEquals(preSaveNarrativeService.getObservingNarrative().getAllReadNarratives(),
                List.of("0", "1-0"));
    ...
    @Test
    void canSaveAndResumeWithoutLosingStringGameStateVariable() {
        final var preSaveNarrativeService = this.narrativeService;
        game.startNewGame();
        // Build chapter and get first node
        game.tick();
    ...
    @Test
    void canSaveAndResumeWithoutLosingBooleanGameStateVariable() {
        final var preSaveNarrativeService = this.narrativeService;
        game.startNewGame();
        // Build chapter and get first node
        game.tick();

...
public class ChapterTransitionPredicatesTest extends PlayTest {
    ...
    String gameConfigLocation() {
        return "src/test/resources/test-chapter-transition-game";
    }
    ...
    @Test
    void willPreserveIntegerGameStateVariablesWhenTransitioningAcrossChapters() {
        game.startNewGame();
    ...
    @Test
    void willPreserveStringGameStateVariablesWhenTransitioningAcrossChapters() {
        game.startNewGame();
        // Build chapter and get first node
        game.tick();
        // Trigger node 0, choose increment $int.gs-int-var-1 by 1
        ...
        // Trigger move to new chapter
        game.tick();
        // Trigger 2 -> ch-2-3-1 (this is the expected route due to the predicate)
        game.tick();
    ...
    @Test
    void willPreserveBooleanGameStateVariablesWhenTransitioningAcrossChapters() {
        game.startNewGame();
        // Build chapter and get first node
        game.tick();
        // Trigger node 0, choose increment $int.gs-int-var-1 by 1
